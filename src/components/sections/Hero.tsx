...
const HeroButtons = () => (
  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full pt-4 px-4 sm:px-0">
    <a
      ...
      target="_blank"
      rel="noopener"
      aria-label="Contactar por WhatsApp para solicitar presupuesto de arenado y granallado"
      className="btn text-white font-semibold text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 bg-btn/25 hover:bg-btn/40 border border-btn/40 hover:border-btn/60 backdrop-blur-md shadow-xl hover:shadow-2xl transition-all duration-300 rounded-xl group relative overflow-hidden"
    >
    ...
    <a
      ...
      target="_blank"
      rel="noopener"
      aria-label="Ver trabajos realizados en nuestro perfil de Instagram"
      className="btn btn-ghost text-white font-medium text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 border border-btn/30 hover:bg-btn/15 hover:border-btn/50 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-300 rounded-xl group relative overflow-hidden"
    >
      <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden pt-16 sm:pt-20">
      ...
      <Container className="flex flex-wrap min-h-screen relative justify-center items-center z-20 px-4 -mt-16 sm:-mt-20">
        <div className="flex flex-col items-center w-full lg:w-4/5 xl:w-3/4">
