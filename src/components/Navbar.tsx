...
export const Navbar = () => {
  ...
  return (
    <div className="w-full">
      <nav className="container relative flex flex-wrap items-center justify-between p-2 mx-auto lg:justify-between xl:px-1 bg-customBlue">
        {/* Logo  */}
        <Link href="/">
        ...
        <div className="gap-3 nav__item mr-2 lg:flex ml-auto lg:ml-0 lg:order-2">
          <ThemeChanger />
            <div className="hidden mr-3 lg:flex nav__item">
              <Link href="/" className="px-6 py-2 text-white bg-btn rounded-md md:ml-5">
                Contactenos
              </Link>
            </div>
        </div>
