...
export const Faq = () => {
  return (
    <Container className="!p-0">
      <div className="w-full max-w-2xl p-2 mx-auto rounded-2xl font-light font-sans">
        {faqdata.map((item, index) => (
          <div key={item.question} className="mb-5 bg-snow3 text-white rounded-lg shadow-md">
            <Disclosure>
              {({ open }) => (
                <>
