    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="bg-gray-800 py-4">
        <Container>
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-xl font-semibold text-white">Servicio de Zincado</h1>
          </div>
        </Container>
      </div>
      ...
      <Container className="py-16">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 border border-green-500/30 rounded-full mb-6">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span className="text-green-500 font-medium text-sm tracking-wide">Zincado Protectivo</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            Zincado de{" "}
            <span className="text-green-500">Máxima Protección</span>
          </h1>
