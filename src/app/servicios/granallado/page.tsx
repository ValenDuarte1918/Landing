...
export default function GranalladoPage() {
  useEffect(() => {
    // Track page view
    trackEvents.serviceView('granallado');
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-32 h-32 bg-btn/10 rounded-full blur-xl animate-pulse-slow"></div>
        <div className="absolute top-40 right-20 w-24 h-24 bg-customBlue/10 rounded-full blur-lg animate-bounce-slow"></div>
        <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-btn/5 rounded-full blur-2xl animate-ping-slow"></div>
        
        {/* Partículas flotantes */}
        <div className="absolute top-1/3 left-1/5 w-2 h-2 bg-btn/30 rounded-full animate-float"></div>
        <div className="absolute top-1/2 right-1/3 w-1 h-1 bg-customBlue/30 rounded-full animate-float-delayed"></div>
        <div className="absolute bottom-1/3 left-2/3 w-3 h-3 bg-btn/20 rounded-full animate-float-slow"></div>
      </div>
      ...
      <div className="bg-gray-800/80 backdrop-blur-sm py-4 border-b border-gray-700/50 relative z-10">
        <Container>
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-xl font-semibold text-white animate-slide-in-right">Servicio de Granallado</h1>
          </div>
        </Container>
      </div>
      ...
      <Container className="py-16 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 border border-btn/30 rounded-full mb-6 bg-gray-800/30 backdrop-blur-sm hover:bg-gray-800/50 transition-all duration-300 hover:scale-105 hover:border-btn/50">
            <div className="w-2 h-2 bg-btn rounded-full animate-pulse"></div>
            <span className="text-btn font-medium text-sm tracking-wide">Tratamiento de Granallado</span>
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6 animate-slide-in-up">
            Granallado de{" "}
            <span className="text-btn font-bold">Alta Precisión</span>
          </h1>
        ...
        <div className="relative h-96 rounded-2xl overflow-hidden mb-16 group animate-slide-in-up transform hover:scale-[1.02] transition-all duration-500 hover:shadow-2xl hover:shadow-btn/20">
          <div className="absolute inset-0 bg-gradient-to-r from-btn/20 to-customBlue/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
          <Image
          ...
          <div className="absolute top-4 right-4 w-16 h-16 border-2 border-btn/30 rounded-full animate-spin-slow opacity-70"></div>
